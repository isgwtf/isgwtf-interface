...
export const colors = {
  ...
  /** #abc4ff */
  textSecondary: '#82ffa1',
  /** #abc4ff80 */
  textTertiary: '#82ffa180',
  textRevertPrimary: 'var(--text-revert-primary)',

  textLink: '#22f858',

  /** 🤔 what's this */
  textQuaternary: '#ccffc4',
  /** 🤔 what's this */
  ...
  backgroundApp: '#00220b59',
  solidButtonBg: '#00d13c',
