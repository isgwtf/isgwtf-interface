...
export const lightTheme = {
  ...
  divider: '#ffffff33',
  background: { default: 'rgba(245, 248, 255, 1)' },
  text: { primary: 'rgba(0, 2, 72, 1)', secondary: 'rgba(71, 74, 187, 1)' },
  error: {
    '50': '#FFEBEE',
    '100': '#FFCDD2',
    '200': '#EF9A9A',
  ...
  options: { hover: '#ffffff0F', select: '#ffffff19' },
  card: { background: 'rgba(255, 255, 255, 1)', secondary: '#ffffff0C', elevation: 'none' },
  popover: { background: '#1B2033', secondary: '#ffffff0C', elevation: 'none' },
